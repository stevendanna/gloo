...
type PluginSource struct {
	...
	// TODO: not a string
	FilterStage string `json: "filterStage"`
...
type AsyncDataSource struct {
	...
	Local *DataSource `json: "local"`

	// Remote async data source.
	Remote *RemoteDataSource `json: "remote"`
}
