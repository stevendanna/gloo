...
type HttpGateway struct {
	...
	// Will be ignored for a given Virtual Service if both the Gateway and the Virtual Service have the same
	// SSL-enabled status and `readAllVirtualServices` is set to `true`.
	...
	// If true, override both `virtualServices` and `virtualServiceSelector` and read all Virtual Services from all
	// watched namespaces whose SSL-enabled status matches this Gateway. Defaults to `false`.
	ReadAllVirtualServices bool `protobuf:"varint,3,opt,name=read_all_virtual_services,json=readAllVirtualServices,proto3" json:"read_all_virtual_services,omitempty"`
...
func (m *HttpGateway) GetReadAllVirtualServices() bool {
	if m != nil {
		return m.ReadAllVirtualServices
	}
	return false
}
...
var fileDescriptor_30f7529f6633771c = []byte{
	...
	,
}
...
func (this *HttpGateway) Equal(that interface{}) bool {
	...
	if this.ReadAllVirtualServices != that1.ReadAllVirtualServices {
		return false
	}
	if !this.Options.Equal(that1.Options) {
		return false
