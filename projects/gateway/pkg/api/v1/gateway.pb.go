...
type HttpGateway struct {
	...
	// It is an error to provide a reference to a virtual service that resides in a namespace not contained in
	// the selectFromNamespaces field (if that field is empty, all watched namespaces will be considered).
	...
	// in namespaces specified by the selectFromNamespaces field (if that field is empty, all watched namespaces will be considered).
	...
	// Restrict the Virtual Services to which this Gateway applies to the namespaces provided in this field.
	// If the list is empty, then any virtual service from any watched namespace will apply.
	// If the list is nonempty, then its contents must be a subset of the watched namespaces.
	SelectFromNamespaces []string `protobuf:"bytes,3,rep,name=select_from_namespaces,json=selectFromNamespaces,proto3" json:"select_from_namespaces,omitempty"`
...
func (m *HttpGateway) GetSelectFromNamespaces() []string {
	if m != nil {
		return m.SelectFromNamespaces
	}
	return nil
}
...
var fileDescriptor_30f7529f6633771c = []byte{
	...
	,
}
...
func (this *HttpGateway) Equal(that interface{}) bool {
	...
	if len(this.SelectFromNamespaces) != len(that1.SelectFromNamespaces) {
		return false
	}
	for i := range this.SelectFromNamespaces {
		if this.SelectFromNamespaces[i] != that1.SelectFromNamespaces[i] {
			return false
		}
	}
	if !this.Options.Equal(that1.Options) {
